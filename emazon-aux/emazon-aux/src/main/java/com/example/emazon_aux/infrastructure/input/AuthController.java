...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtResponseDto> login(@Valid @RequestBody LoginRegister loginRegister) {
        return new ResponseEntity<>(authHandler.login(loginRegister), HttpStatus.OK);
    }
